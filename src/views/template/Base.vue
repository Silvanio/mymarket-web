...
export default {
  data() {
    return {
      ...
      darkMenu: true,
      menu: [
        {label: this.$t('menu.lbl_initial'), icon: 'fa fa-fw fa fa-home', to: '/empty', auth: true},
        {
          label: this.$t('menu.lbl_register'), icon: 'fa fa-fw fa-database', auth: true,
          items: [
            {
              label: this.$t('menu.lbl_stock'), icon: 'fa fa-fw fa-briefcase', to: '/stock/consult',
              auth: this.isAuthorizedRules(["MY_MARKET_ADMIN"])
            },
            {
              label: this.$t('menu.lbl_product'), icon: 'fa fa-fw fa-building', to: '/product/consult',
              auth: this.isAuthorizedRules(["MY_MARKET_ADMIN"])
            },
            {
              label: this.$t('menu.lbl_sector'), icon: 'fa fa-fw fa-building', to: '/sector/consult',
              auth: this.isAuthorizedRules(["MY_MARKET_ADMIN"])
            },
            {
              label: this.$t('menu.lbl_sub_sector'), icon: 'fa fa-fw fa-building', to: '/sub-sector/consult',
              auth: this.isAuthorizedRules(["MY_MARKET_ADMIN"])
            },
            {
              label: this.$t('menu.lbl_segment'), icon: 'fa fa-fw fa-building', to: '/segment/consult',
              auth: this.isAuthorizedRules(["MY_MARKET_ADMIN"])
            },
            {
              label: this.$t('menu.lbl_broker'), icon: 'fa fa-fw fa-exchange', to: '/broker/consult',
              auth: this.isAuthorizedRules(["MY_MARKET_ADMIN"])
            },
            {
