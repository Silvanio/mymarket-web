  ...
  <div class="p-grid">
    <div class="p-col-12">
      <div class="card">
        <h1>
          {{ title }}
          <Button style="float: right" icon="pi pi-plus-circle" class="p-button-rounded p-shadow-7" @click="openCreate" v-tooltip.left="$t('segment.lbl_create_title')"/>
        </h1>

        <div class="p-fluid p-formgrid p-grid">

          <div class="p-field p-col-12 p-md-3">
            <InputText type="text" id="NameSegment" v-model="pageable.entity['name']" class="p-column-filter"
                       :placeholder="$t('segment.lbl_name')"/>
          </div>

          <div class="p-field p-col-12 p-md-3">
            <Dropdown v-model="pageable.entity['subSector']" :options="subSectorList" optionLabel="name"
                      :placeholder="$t('segment.lbl_sub_sector')" class="p-column-filter" :showClear="true">
        ...
        <div class="p-fluid p-formgrid p-grid">
          <div class="p-field p-col-12">
            <DataTable class="p-datatable-responsive p-datatable-sm p-datatable-striped p-datatable-gridlines"
              ...
              <Column field="name" :header="$t('segment.lbl_name')" :sortable="true" filterMatchMode="contains" headerStyle="text-align: center" bodyStyle="text-align: center;"/>

              <Column field="subSector.name" :header="$t('segment.lbl_sub_sector')" :sortable="true" filterMatchMode="contains" headerStyle="text-align: center" bodyStyle="text-align: center;"/>
...
export default {
  ...
  data() {
    return {
      crud: "segment",
      subSectorList: null,
      title: this.$t('segment.lbl_consult_title'),
    }
  },
  methods: {
    async initConsult(){
