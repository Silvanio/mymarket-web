  ...
  <div class="p-grid">
    <div class="p-col-12">
      <div class="card">
        <h1>
          {{ title }}
          <Button style="float: right" icon="pi pi-plus-circle" class="p-button-rounded p-shadow-7" @click="openCreate" v-tooltip.left="$t('broker.lbl_create_title')"/>
        </h1>

        <div class="p-fluid p-formgrid p-grid">
          <div class="p-field p-col-12 p-md-2">
            <InputText type="text" id="codeBroker" v-model="pageable.entity['code']" class="p-column-filter"
                       :placeholder="$t('broker.lbl_code')"/>
          </div>
          <div class="p-field p-col-12 p-md-2">
            <InputText type="text" id="NameBroker" v-model="pageable.entity['name']" class="p-column-filter"
                       :placeholder="$t('broker.lbl_name')"/>
          </div>
        ...
        <div class="p-fluid p-formgrid p-grid">
          <div class="p-field p-col-12">
            <DataTable class="p-datatable-responsive p-datatable-sm p-datatable-striped p-datatable-gridlines"
              ...
              <Column field="code" :header="$t('broker.lbl_code')" :sortable="true" filterMatchMode="contains" headerStyle="text-align: center" bodyStyle="text-align: center;"/>

              <Column field="name" :header="$t('broker.lbl_name')" :sortable="true" filterMatchMode="contains" headerStyle="text-align: center" bodyStyle="text-align: center;"/>
...
export default {
  ...
  data() {
    return {
      crud: "broker",
      title: this.$t('broker.lbl_consult_title'),
    }
  },
  methods: {
    getService() {
