  ...
  <div class="p-grid">
    <div class="p-col-12">
      <div class="card">
        <h1>
          {{ title }}
          <Button style="float: right" icon="pi pi-plus-circle" class="p-button-rounded p-shadow-7" @click="openCreate" v-tooltip.left="$t('sector.lbl_create_title')"/>
        </h1>
...
export default {
  ...
  data() {
    return {
      crud: "sector",
      title: this.$t('sector.lbl_consult_title'),
    }
  },
  methods: {
    getService() {
